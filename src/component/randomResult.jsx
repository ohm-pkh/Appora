...
export function InCart({data,Location,onClose}){
    ...
    return(
        <div style={{position:'relative', textAlign:'left'}}>
            ...
            <button style={{backgroundColor:'white',color:'black',borderColor:'black',width:'100%',marginTop:'0.5em',display:'flex', justifyContent:'center'}} onClick={()=>{r = getRandomItem(data);}}>
                <span style={{display:"flex",justifyContent:'center'}}>
